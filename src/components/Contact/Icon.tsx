...
function Icon({icon, style, iconStyle, className, setCopied, copied} : IconProps) {
  ...
  const handleMouseLeave = () => {
    setCurrentIcon(null);
    // Add a slight delay before hiding the stars
  ...
  return (
    ...
    >
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        style={iconStyle}
        ref={targetRef}
        onMouseEnter={() => {handleMouseEnter(); setCurrentIcon('instagram')}}
        onMouseLeave={handleMouseLeave}
        onClick={copyToClipboard.bind(null, 'https://www.instagram.com/johnnytalbot_/') }
      >
    ...
    >
      <svg width="100" height="102" viewBox="0 0 100 102" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        style={iconStyle}
        ref={targetRef}
        onMouseEnter={() => {handleMouseEnter(); setCurrentIcon('linkedin')}}
        onMouseLeave={handleMouseLeave}
        onClick={copyToClipboard.bind(null, 'https://www.linkedin.com/in/jonathan-talbot8/') }
      >
    ...
    >
      <svg width="102" height="100" viewBox="0 0 102 100" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        style={iconStyle}
        ref={targetRef}
        onMouseEnter={() => {handleMouseEnter(); setCurrentIcon('github')}}
        onMouseLeave={handleMouseLeave}
        onClick={copyToClipboard.bind(null, 'https://github.com/JohnnyTalbot')}
      >
    ...
    >
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        style={iconStyle}
        ref={targetRef}
        onMouseEnter={() => {handleMouseEnter(); setCurrentIcon('phone')}}
        onMouseLeave={handleMouseLeave}
        onClick={copyToClipboard.bind(null, '+63 917 547 8749') }
      >
    ...
    >
      <svg width="100" height="80" viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        style={iconStyle}
        ref={targetRef}
        onMouseEnter={() => {handleMouseEnter(); setCurrentIcon('email')}}
        onMouseLeave={handleMouseLeave}
        onClick={copyToClipboard.bind(null, 'johnnywtalbot@gmail.com')}
      >
